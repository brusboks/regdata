...
Før du kan bruke registerdata i statistikk eller forskning, trenger du et klart bilde av hva slags data dette faktisk er, og hvordan de brukes. Vi starter med å gi en definisjon, og hva som kjennetegner registerdata. Videre beskrives hvordan opplysninger registrert i administrative prosesser blir til registerdatasett, statistikk og til å besvare forskningsspørsmål. En stor andel av den offentlige statistikk i Norge i stor grad bygger på administrative

Registerdata registre, og dette illustreres med konkrete eksempler. Deretter viser vi gjennom utvalgte forskningsstudier, hvordan registerdata gjør det mulig å analysere hele populasjoner, følge personer over tid og undersøke komplekse sammenhenger på tvers av sektorer som utdanning, arbeid, helse og velferd. Målet er at du skal forstå både hva registerdata er, hvorfor de er så sentrale i norsk forskning, og hvilke typer spørsmål de kan gi svar på.

Når du leser beskrivelser av hvilket datagrunnlag som er brukt i statistikk eller forskningsartikler har du kanskje lagt merke til at _registerdata_ ofte bare blir nevnt uten noen nærmere forklaring. Det virker å være en slags implisitt forventning om at alle vet hva registerdata \[KG1] er, hvordan de blir til, og hva de kan brukes til. For mange som møter begrepet for første gang, kan det derfor være uklart hva som egentlig ligger i begrepet.
